...
<div className="color-overlay" />  
      ...
      {/* Decorative cloud */}
      <img src="/assets/cloud-right.svg" className="cloud cloud-right" />

      <div className="about-wrapper">
        {/* LEFT */}
        <div className="about-title">
          <img src="/assets/cloud.svg" className="cloud cloud-top" />
          ...
          <img src="/assets/cloud-left.svg" className="cloud cloud-bottom" />
        </div>
      ...
      <div className="icon-strip">
        <img src="/assets/icon.svg" alt="Cultural icons" />
      </div>
    </section>
  );
};
